...
| **&emsp; ∟ data**                              | Object              | 字段值       | 必填   | -     | 格式为 {字段名称:字段值}。`字段名称`是[获取扩展业务对象](/docs/open-api/datalink/get-entity-list)返回值中的 `fields` 里面的 `name` 值|
...
| **&emsp; &emsp; ∟ staffs**                     | Array&lt;String&gt; | 可见员工id    | 非必填 | -     | 值为[员工id](/docs/open-api/corporation/get-all-staffs) |
| **&emsp; &emsp; ∟ roles**                      | Array&lt;String&gt; | 可见角色id    | 非必填 | -     | 值为[角色id](/docs/open-api/corporation/get-roles-group) |
| **&emsp; &emsp; ∟ departments**                | Array&lt;String&gt; | 可见部门id    | 非必填 | -     | 值为[部门id](/docs/open-api/corporation/get-departments) |
