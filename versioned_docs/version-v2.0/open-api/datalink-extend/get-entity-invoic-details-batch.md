...
| 名称 | 类型 | 描述 | 是否必填 | 默认值 | 备注 |
| :--- | :--- | :--- | :--- |:--- | :--- |
| **invoiceIds** | Array | 发票ID数组 | 必填 | - | 可以通过[获取单据详情](/docs/open-api/flows/get-forms-details)接口<br/>或[根据单据编号或单据ID查询发票和其明细ID](/docs/open-api/datalink-extend/get-flow-invoice)接口获取 |
