...
| :--- | :--- | :--- | :--- |:--- | :--- |
| **invoiceId** | String | 发票ID | 必填 | - | 可以通过[获取单据详情](/docs/open-api/flows/get-forms-details)接口<br/>或[根据单据编号或单据ID查询发票和其明细ID](/docs/open-api/datalink-extend/get-flow-invoice)接口获取 |
