...
<details>
  ...
  [**1.7.0**](/updateLog/update-log#170) -> 🐞 **报销单、收款单** 类型返回数据中新增了 `writtenOffRecords`（核销借款记录）参数。<br/>
  [**1.5.0**](/updateLog/update-log#150) -> 🚀 接口升级 `v1.1` 版本，报销单类型返回数据中新增了 `expenseLink`（费用明细关联的申请单ID）参数。<br/>
